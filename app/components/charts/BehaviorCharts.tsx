  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="text-center">
        <p className="text-xs text-muted">Avg Listen Duration</p>
      ...
      <div>
        <h4 className="text-xs text-muted mb-2">Shuffle Usage Over Time</h4>
        <ResponsiveContainer width="100%" height={200}>
          <LineChart data={shuffleOverTime}>
            ...
            <Tooltip
              formatter={(value: number) => [`${value}%`, "Shuffle Rate"]}
            />
            <Line
              type="monotone"
              dataKey="shuffleRate"
